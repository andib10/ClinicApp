...
import com.licenta.MedicalClinic.user.PasswordModel;
...
public class UserController {
    ...
    public UserController(UserService userService, RoleDao roleDao, EmailService emailService, EmailTemplateService emailTemplateService) {
    ...
    public String saveUser(@ModelAttribute("user") User theUser) {
        ...
        String emailContent = emailTemplateService.buildAdminRegistrationEmail(theUser);
