...
import com.licenta.MedicalClinic.service.AvailabilityService;
import com.licenta.MedicalClinic.service.DoctorService;
...
public class AvailabilityController {
   ...
   /* @PostMapping("/save")
    public String saveAvailability(@ModelAttribute("availability") Availability theAvailability) {
        List<Doctor> doctors = doctorService.findAllById(theAvailability.getDoctorIds());
        theAvailability.setDoctors(doctors);
        availabilityService.save(theAvailability);
